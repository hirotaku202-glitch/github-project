...
const SEED = {
  brands: [
    ...
    { id: 'limbrow', name: 'Lim brow', type: '眉毛サロン（新ブランド）', cls: 'limbrow',
      policy: 'Lim eyelash併設の眉毛サロン。眉毛の新規出店はLim browで展開・拡大。' },
    { id: 'brow', name: '8BROW', type: '眉毛サロン（既存3拠点）', cls: 'brow',
      policy: '地域で認知された看板。無理なリブランドはせず3拠点を維持・運営改善。' },
    ...
    { id: 'bright', name: 'Beauty Bright', type: '美容（エステ系）', cls: 'bright',
      policy: '八日市複合店の一業態として維持。同拠点の8BROWと併売。' },
  ],
  stores: [
...
function renderDashboard() {
  ...
  const growth = [
    ...
    { label: 'Lim brow（眉毛・新ブランド）', cls: 'limbrow', cur: 1, goal: 5 },
    { label: '8BROW（既存3拠点を維持）', cls: 'brow', cur: 3, goal: 3 },
